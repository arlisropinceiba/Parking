...
//  Presentation
//
//  Created by Arlin Lisette Ropero Infante - Ceiba Software on 3/03/22.
//
...
class StrategyRealWorld: XCTestCase {
    ...
    private func usersFromNetwork() -> [User] {
        let firstUser = User(uid: 1, username: "username1")
        let secondUser = User(uid: 2, username: "username2")
...
class CoreDataStorage: DataSource {
    ...
    func loadModels<T: DomainModel>() -> [T] {
        ...
        let firstUser = User(uid: 3, username: "username3")
        let secondUser = User(uid: 4, username: "username4")
...
class RealmStorage: DataSource {
    ...
    func loadModels<T: DomainModel>() -> [T] {
        ...
        let firstUser = User(uid: 5, username: "username5")
        let secondUser = User(uid: 6, username: "username6")
