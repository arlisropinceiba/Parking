//
//  MotorcycleLogItemTableViewCell.swift
//  Presentation
//
...
class MotorcycleLogItemTableViewCell: UITableViewCell, LogItemTableViewCell {
    ...
    func initWithData(vehicle: VehicleVisible) {
        ...
        vehicleImage.image = motorcycle.getImage()
        let addmissionDate = motorcycle.getAdmissionDate().inDateHourFormat()
        let departureDate = (motorcycle.getDepartureDate() ?? Date()).inDateHourFormat()
        let descriptionVehicle = "\(motorcycle.getCylinderCapacity()) CC"
